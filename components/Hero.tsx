...
const code = `export default {
  charms: 'Bitcoin can be used in markets',
  zkVerification: 'Outcomes are enforced cryptographically',
  noWrapping: 'Bitcoin stays native'
}`;

const tabs = [
  { name: "now-possible-on-bitcoin.ts", isActive: true },
          ...
          <div className="relative z-10 md:text-center lg:text-left">
            ...
            <div className="relative">
              <p className="inline bg-linear-to-r from-amber-200 via-amber-400 to-amber-200 bg-clip-text font-display text-5xl tracking-tight text-transparent">
                Prediction Markets on Bitcoin powered by Charms
              </p>
              <p className="mt-3 text-2xl tracking-tight text-slate-400">
                Hard money makes honest markets inevitable
              </p>
              <div className="mt-8 flex gap-4 md:justify-center lg:justify-start">
                <Button href="/">Get started</Button>
                <Button
                  href="https://github.com/EchoMarkets"
                  variant="secondary"
                  target="_blank"
