export const navigation = [
  ...
  },
  {
    ...
    links: [
      ...
      { title: "trade.yaml", href: "/docs/spells/trade" },
      { title: "resolve-market.yaml", href: "/docs/spells/resolve-market" },
      { title: "redeem.yaml", href: "/docs/spells/redeem" },
      { title: "cancel-market.yaml", href: "/docs/spells/cancel-market" },
      { title: "claim-fees.yaml", href: "/docs/spells/claim-fees" },
    ],
  },
  {
